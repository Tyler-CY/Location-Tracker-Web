export default class LocationSnapshot {
    ...
    constructor(options: { recordTimeISOString?: string | null; recordTimeUnixEpoch?: number | null; snapshotTimeISOString?: string | null; snapshotTimeUnixEpoch?: number | null; latitude?: number | null; longitude?: number | null; speed?: number | null; hasSpeed?: boolean; hasAltitude?: boolean; altitude?: number | null; }) {
